                ...
                <div className="container mx-auto max-w-4xl">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2">
                            ...
                            {service.meta?.therapeutic_approaches && (
                            ...
                            {/* Conditions Treated */}
                            {service.meta?.conditions_treated && (
                            ...
                            {/* Services Offered (for Podiatry, etc.) */}
                            {service.meta?.services_offered && (
                            ...
                            {/* Booking Information */}
                            {service.meta?.booking_information && (
                                <div className="mt-6 p-6 bg-brand-50 rounded-lg border border-brand-200">
                                    <h3 className="text-xl font-serif mb-4 text-brand-800">Booking Information</h3>
                                    <p className="text-stone-700 whitespace-pre-line">{service.meta.booking_information}</p>
                                </div>
                            )}

                            {/* Accreditation Note */}
                            {service.meta?.accreditation_note && (
                                <div className="mt-6 p-4 bg-stone-50 rounded-lg border-l-4 border-brand-600">
                                    <p className="text-sm text-stone-600 italic">{service.meta.accreditation_note}</p>
                                </div>
                            )}
                        </div>
