...
export default function ClientHome({ therapies, therapists, homepageSettings, accreditationLogos }: ClientHomeProps) {
    ...
    const heroImage = (homepageSettings?.hero_image && homepageSettings.hero_image.trim() !== '') 
        ...
        : '/resources/Room 1 Wideshot .jpg';
    const heroTitle = homepageSettings?.hero_title || 'We Heal By Listening And Understanding Your Pain.';
    ...
    return (
        <main className="min-h-screen bg-brand-50 text-stone-800 font-sans selection:bg-brand-200 selection:text-stone-900">
            ...
            <AnimatedSection className="py-16 px-6 bg-white border-b border-stone-100">
                <div className="container mx-auto max-w-6xl">
                    ...
                    >
                        <h2 className="text-2xl md:text-3xl font-serif font-medium text-brand-900 mb-3">
                            Trusted & Accredited
                        </h2>
                        <p className="text-brand-700 text-sm md:text-base max-w-2xl mx-auto">
                        ...
                        {logos.map((logo, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="flex items-center justify-center p-6 bg-stone-50 rounded-xl hover:bg-stone-100 transition-colors w-full shadow-sm"
                                >
                                    <Image
                                        src={imageUrl}
                                        alt={logo.alt_text}
